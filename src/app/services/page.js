...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      shortDesc: "Coordinated support for complex needs",
      description:
        "Our experienced Support Coordinators help you navigate the NDIS, connect with service providers, and maximize your plan. We coordinate complex supports, monitor service delivery, and ensure your NDIS funding is used effectively to achieve your goals.",
  ...
  const faqs = [
    ...
    {
      question: "Are your staff qualified to support people with complex needs?",
      answer:
    ...
    {
      question: "What happens if I need to change or cancel a scheduled service?",
      answer:
      ...
      <section className="relative py-20 bg-gradient-to-r from-[#0055c2]/5 to-[#ED19A6]/5 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto mb-8">
            Personalized care and support to help you achieve your goals and live your best life.
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-700">
              Success Healthcare Group offers a comprehensive range of NDIS-registered services delivered by qualified
              professionals who are passionate about supporting people with disabilities.
            </p>
          </div>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <Button variant="ghost" className="group p-0 hover:bg-transparent text-[#0055c2]">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="h-1 w-20 bg-[#ED19A6] mx-auto mb-8 rounded-full"></div>
            <p className="text-lg text-gray-700">
              Learn more about each of our specialized services and how they can support your unique needs.
            </p>
          </div>
          ...
          <Tabs defaultValue="nursing" className="w-full max-w-5xl mx-auto">
            ...
            {services.map((service) => (
              <TabsContent key={service.id} value={service.id} className="border-0 p-0">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start">
                          ...
                          <span>Personalized support plans tailored to your needs</span>
                        </li>
                        <li className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-[#0055c2] mr-2 flex-shrink-0 mt-0.5" />
                        ...
                        <li className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-[#0055c2] mr-2 flex-shrink-0 mt-0.5" />
                          <span>Regular reviews to ensure quality outcomes</span>
                        </li>
                      </ul>
                    </div>
                    <Button className="bg-[#0055c2] hover:bg-[#0055c2]/90 text-white">Enquire About This Service</Button>
                  </div>
                </div>
              </TabsContent>
            ))}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="h-1 w-20 bg-[#ED19A6] mx-auto mb-8 rounded-full"></div>
            <p className="text-lg text-gray-700">
              Our simple process ensures you get the support you need, when you need it.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-12 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                description: "We develop a personalized support plan aligned with your NDIS goals.",
              },
              {
                icon: Users,
                title: "Staff Matching",
                description: "We match you with support workers who have the right skills and personality.",
              },
              {
                icon: Sparkles,
                title: "Ongoing Support",
                description: "We provide consistent, high-quality support with regular reviews.",
              },
            ].map((step, index) => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Qualified Team</h2>
                <div className="h-1 w-20 bg-[#ED19A6] mb-8 rounded-full"></div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Our team consists of highly qualified professionals dedicated to providing exceptional care and
                  support. All our staff undergo rigorous screening, training, and ongoing professional development.
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Experienced in disability and complex care needs</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-[#0055c2] mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold">Qualified Support Workers</span>
                      <p className="text-gray-700">Certificate III or IV in Disability or Individual Support</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-[#0055c2] mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold">Behavior Support Practitioners</span>
                      <p className="text-gray-700">Specialized training in positive behavior support</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-[#0055c2] mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold">Support Coordinators</span>
                      <p className="text-gray-700">Extensive knowledge of the NDIS and local services</p>
                    </div>
                  </li>
                </ul>
                <Button className="bg-[#0055c2] hover:bg-[#0055c2]/90 text-white">Meet Our Team</Button>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">NDIS Funding</h2>
                <div className="h-1 w-20 bg-[#ED19A6] mb-8 rounded-full"></div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  As a registered NDIS provider, our services can be funded through your NDIS plan. We can help you
                  understand how to use your funding effectively to achieve your goals.
                </p>
                <div className="space-y-6 mb-8">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      If your funding is plan managed, your plan manager can process our invoices directly.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h3 className="text-xl font-bold mb-3 flex items-center">
                    ...
                    <p className="text-gray-700">
                      As a registered provider, we can claim directly from the NDIA for your supports.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h3 className="text-xl font-bold mb-3 flex items-center">
                    ...
                    <p className="text-gray-700">
                      If you self-manage your funding, we'll provide invoices for you to submit for reimbursement.
                    </p>
                  </div>
                </div>
                <Button className="bg-[#0055c2] hover:bg-[#0055c2]/90 text-white">Learn More About Funding</Button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#0055c2] to-[#0055c2]/80 rounded-2xl p-8 md:p-12 shadow-xl text-white text-center">
            ...
            <p className="text-lg md:text-xl mb-8 opacity-90">
              Contact us today to discuss how our services can support you to achieve your goals.
            </p>
